...
export class ViralityScoringSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'ViralityScoringSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for ViralityScoringSubagent' };
  }
