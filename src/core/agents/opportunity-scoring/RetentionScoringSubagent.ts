...
export class RetentionScoringSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'RetentionScoringSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for RetentionScoringSubagent' };
  }
