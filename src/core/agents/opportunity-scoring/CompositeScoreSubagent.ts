...
export class CompositeScoreSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'CompositeScoreSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for CompositeScoreSubagent' };
  }
