...
export class CompetitionScoringSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'CompetitionScoringSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for CompetitionScoringSubagent' };
  }
