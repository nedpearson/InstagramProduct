...
export class ViabilityScoringSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'ViabilityScoringSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for ViabilityScoringSubagent' };
  }
