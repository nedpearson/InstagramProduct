...
export class AutomationScoringSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'AutomationScoringSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for AutomationScoringSubagent' };
  }
