...
export class OpportunityHarvestAgent extends AbstractAgent<any, any> {
  readonly agentName = 'OpportunityHarvestAgent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for OpportunityHarvestAgent' };
  }
