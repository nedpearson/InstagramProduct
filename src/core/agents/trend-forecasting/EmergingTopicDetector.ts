...
export class EmergingTopicDetector extends AbstractAgent<any, any> {
  readonly agentName = 'EmergingTopicDetector';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for EmergingTopicDetector' };
  }
