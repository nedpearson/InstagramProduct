...
export class DeclineRiskDetector extends AbstractAgent<any, any> {
  readonly agentName = 'DeclineRiskDetector';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for DeclineRiskDetector' };
  }
