...
export class AudienceParsingSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'AudienceParsingSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for AudienceParsingSubagent' };
  }
