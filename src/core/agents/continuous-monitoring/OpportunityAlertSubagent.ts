...
export class OpportunityAlertSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'OpportunityAlertSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for OpportunityAlertSubagent' };
  }
