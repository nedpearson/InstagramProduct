...
export class ScoreDriftSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'ScoreDriftSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for ScoreDriftSubagent' };
  }
