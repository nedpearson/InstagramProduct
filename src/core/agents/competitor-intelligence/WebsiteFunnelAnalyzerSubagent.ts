...
export class WebsiteFunnelAnalyzerSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'WebsiteFunnelAnalyzerSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for WebsiteFunnelAnalyzerSubagent' };
  }
