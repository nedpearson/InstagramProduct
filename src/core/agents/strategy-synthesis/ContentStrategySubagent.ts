...
export class ContentStrategySubagent extends AbstractAgent<any, any> {
  readonly agentName = 'ContentStrategySubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for ContentStrategySubagent' };
  }
