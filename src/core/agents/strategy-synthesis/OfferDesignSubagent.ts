...
export class OfferDesignSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'OfferDesignSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for OfferDesignSubagent' };
  }
