...
export class RoadmapGenerationSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'RoadmapGenerationSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for RoadmapGenerationSubagent' };
  }
