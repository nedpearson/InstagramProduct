...
export class MarketResearchAgent extends AbstractAgent<any, any> {
  readonly agentName = 'MarketResearchAgent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for MarketResearchAgent' };
  }
