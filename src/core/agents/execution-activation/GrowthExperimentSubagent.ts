...
export class GrowthExperimentSubagent extends AbstractAgent<any, any> {
  readonly agentName = 'GrowthExperimentSubagent';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for GrowthExperimentSubagent' };
  }
