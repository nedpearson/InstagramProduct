...
export class LeadMagnetGenerator extends AbstractAgent<any, any> {
  readonly agentName = 'LeadMagnetGenerator';
  readonly maxRetries = 2;
  protected async performWork(ctx: AgentContext, payload: any): Promise<any> {
    return { data: 'Scaffolded output for LeadMagnetGenerator' };
  }
