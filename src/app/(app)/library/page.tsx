      ...
      <div className="glass-panel-ai ai-scan-panel border-white/[0.05] shadow-sm rounded-2xl overflow-hidden relative z-10 hover:border-white/[0.09] transition-colors duration-300">
        ...
        <div className="p-6 border-b border-white/5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-white/[0.01]">
          <div className="relative w-full md:w-80 group">
            ...
            <input type="text" placeholder="Search assets..." className="w-full pl-11 pr-4 py-3 border border-white/[0.08] bg-white/[0.03] rounded-xl text-[13px] font-medium outline-none focus:ring-1 focus:ring-indigo-500/40 focus:border-indigo-500/40 text-white transition-all shadow-inner placeholder:text-zinc-600" />
          </div>
          <button className="flex items-center gap-2 px-5 py-3 bg-white/[0.04] border border-white/[0.08] text-white text-[13px] font-bold rounded-xl hover:bg-white/[0.07] transition-colors shadow-inner">
              ...
              {assets.length === 0 && (
                <tr>
                   <td colSpan={5} className="py-20 text-center">
                    <div className="w-14 h-14 bg-white/[0.04] border border-white/[0.07] rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-inner">
                      <Library className="w-6 h-6 text-zinc-600" />
                    </div>
                    <div className="ai-section-label mb-3 justify-center flex">Library · Empty</div>
                    <p className="text-white font-black text-[16px] mb-2">No assets yet</p>
                    <p className="text-zinc-600 font-medium text-[12px]">Content generated by your campaigns will appear here.</p>
                 </td>
                </tr>
              )}
            </tbody>
