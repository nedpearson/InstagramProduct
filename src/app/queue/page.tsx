  ...
  return (
    <div className="p-4 lg:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-700 ease-out">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 relative z-10">
        <div>
          <h1 className="text-4xl lg:text-5xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-white via-zinc-200 to-zinc-600 drop-shadow-sm">Review Queue</h1>
      ...
      <div className="glass-panel rounded-3xl overflow-hidden shadow-sm hover:shadow-[0_0_30px_rgba(255,255,255,0.05)] transition-shadow duration-500 relative z-10 border border-white/5">
        {reviews.length === 0 ? (
          <div className="p-20 text-center flex flex-col items-center relative overflow-hidden group/empty bg-black/40">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/10 via-transparent to-transparent opacity-0 group-hover/empty:opacity-100 transition-opacity duration-1000" />
            <div className="w-24 h-24 bg-emerald-500/10 rounded-full flex items-center justify-center mb-8 ring-[10px] ring-emerald-500/5 group-hover/empty:scale-110 transition-transform duration-500 shadow-inner">
               <Check className="w-12 h-12 text-emerald-400 drop-shadow-[0_0_10px_rgba(16,185,129,0.8)]" />
            </div>
            <h3 className="text-3xl font-black text-white mb-3">All tasks completed</h3>
            <p className="text-zinc-400 font-medium max-w-md">There are no operational tasks waiting for your review. Automation is running smoothly.</p>
          </div>
        ) : (
                     ...
                     <tr key={review.id} className="group hover:bg-white/[0.02] transition-colors">
                       <td className="px-8 py-6">
                         <div className="flex items-center gap-5">
                           <div className="w-12 h-12 rounded-2xl bg-orange-500/10 flex items-center justify-center text-orange-400 shadow-inner border border-orange-500/20 group-hover:scale-105 transition-transform duration-300 shrink-0">
                       ...
                       <td className="px-8 py-6 text-right">
                         <form action={onSubmitForm} className="flex gap-3 justify-end items-center">
                           ...
                           <button name="action" value="approve" className="flex items-center gap-2 px-6 py-3 bg-white text-black hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] font-black rounded-xl hover:bg-zinc-200 transition-all shadow-md active:scale-95 flex-shrink-0">
